...
const InputSearch = () =>{
    ...
    <div className="h-12 bg-white w-full rounded mb-2 mt-2">
        ...
        <div className="flex-row flex">            
            <input 
                className="h-9 w-full border-gray-300 block bg-grey-lighter text-gray-500 text-sm rounded px-2 " 
                id="name" 
                name="name"
                type="text" 
                value={name}
            ...
            className="h-7 w-7 border z-10 -ml-14 mt-1 border-transparent shadow-sm text-sm font-medium rounded-full text-gray-600">
                <FontAwesomeIcon icon={faTimes} />
            </button>
            <button 
            onClick={() => handleSearch()}
            className="h-7 w-7 border z-10 -ml-2 mt-1 border-transparent shadow-sm text-sm font-medium rounded-full text-gray-600">

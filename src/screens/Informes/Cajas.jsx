        ...
        <div className="p-3 flex flex-row justify-center text-xs">     
          <div className="w-full">     
            ...
            <div className="h-26 text-center">
                ...
                <h6 className="text-sm font-bold mt-2">INFORME DE CAJAS</h6>
            ...
            <div className="border-1 border-gray-300 p-1 rounded-md m-1">                                
                ...
                <thead>
                    ...
                    <th className="w-2/12 border border-slate-300 bg-gray-200">Total Inicial</th>
                    <th className="w-2/12 border border-slate-300 bg-gray-200">Total Ingreso</th>
                    <th className="w-2/12 border border-slate-300 bg-gray-200">Total Egreso</th>
                    <th className="w-2/12 border border-slate-300 bg-gray-200">Total Final</th>                    
                    <th className="w-1/12 border border-slate-300 bg-gray-200">F.Cierre</th>                    
                    </tr>
                </thead>
                <tbody>
                    { props.pdata && (
                        props.pdata.map(item =>(
                            <tr key={item.id} className="hover:bg-gray-100 h-5">
                                ...
                                <td className="border pl-1">{item.Usuario.nombre ? item.Usuario.nombre : null}</td>   
                                ...
                                <td className="border pl-1"><Moment format="DD/MM/YYYY">{item.fechaCierre}</Moment></td>                                                                          
